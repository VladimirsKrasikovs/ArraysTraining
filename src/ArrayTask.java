...
public class ArrayTask {
    public static void main(String[] args) {
        ...
        //The next set of exams have occurred. Using 4 lines of code, manually enter the scores
        // (89.7, 90.5, 93.6, 88.1) for the second exam (column 1). Use the provided print statement to print the updated 2D array as well.
        scores[0][1] = 89.7;
        scores[1][1] = 90.5;
        scores[2][1] = 93.6;
        scores[3][1] = 88.1;
